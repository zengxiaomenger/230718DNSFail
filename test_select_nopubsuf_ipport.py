...
init()
file_name='source_data_new/2023-08-29-DNS.csv'
#下面这个要对应准
...
for line in tqdm(csv_in):
    ...
    if QorR=='0':
        continue
    if '192.168.114.169:3911' in Qname:
...
dfout_sorted=dfout.sort_values(by=['Client'])
print('sorting dataframe...')
dfout_sorted.to_csv('other_data/test_select_nopubsuf_ipport29.csv')