...
init()
Lis_tp='qwertyuiopasdfghjklzxcvbnm1234567890-.'
def judge_legal(Qname):
    for c in Qname:
        if c not in Lis_tp:
            return False
    return True

file_name='source_data_new/2023-09-14-DNS.csv'
#下面这个要对应准
...
dfout_sorted=dfout.sort_values(by=['Rcode','Client'])
print('sorting dataframe...')
dfout_sorted.to_csv('other_data/test_select_telegream-14.csv')